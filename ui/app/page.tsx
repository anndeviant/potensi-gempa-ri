        ...
        (error) => {
          ...
          switch (error.code) {
            case error.PERMISSION_DENIED:
              alert(
                "Izin lokasi ditolak. Mohon aktifkan GPS di pengaturan browser untuk memudahkan penggunaan fitur Peta Potensi Gempa Indonesia.",
              );
              break;
    ...
    <div className="flex flex-col w-full overflow-hidden bg-gray-100">
      ...
      <div className="text-white text-center relative">
        ...
        <div className="relative z-2 pt-14 lg:pt-32 px-4 pb-10 font-(Inter) lg:h-full">
          ...
          <div className="flex lg:px-20 gap-5 lg:gap-14 flex-col lg:flex-row justify-center items-center lg:items-start pb-7 md:pb-10">
          ...
          <button
            ...
            className="relative my-0 md:my-4 lg:my-10 px-4 py-2 text-lg bg-black font-bold rounded-3xl hover:bg-linear-to-r from-[#ef9917] to-[#e2eb60] cursor-pointer hover:text-gray-700 transition-colors
          after:content-['']
          after:absolute 
          after:top-1/2 
          after:left-1/2
      ...
      <div className="text-center text-sm text-gray-500 mb-5">
        <h1>
          copyright &copy; 2026 Peta Potensi Gempa Indonesia. All rights
          reserved.
        </h1>
      </div>
    </div>
